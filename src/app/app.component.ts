...
export class AppComponent implements OnInit {
  ...
  start() {
    ...
    const confetti = new (window as any).ConfettiGenerator(confettiSettings);
    confetti.render();
    ...
    let x = setInterval(function () {
      ...
      // document.getElementById('day').innerText = Math.floor(distance / day) as unknown as string;
      ...
      let w = ((canvasC as any).width = window.innerWidth),
        h = ((canvasC as any).height = window.innerHeight),
        ctx = (canvasC as any).getContext('2d'),
        hw = w / 2, // half-width
        hh = h / 2,
        opts = {
      ...
      function Letter(char, x, y) {
        ...
        let hue = (x / calc.totalWidth) * 360 as unknown as string;
      ...
      window.addEventListener('resize', function () {
        w = (canvasC as any).width = window.innerWidth;
        h = (canvasC as any).height = window.innerHeight;
  ...
  playThemeSong() {
    this.themeSongAudio.play();
  }

  pauseThemeSong() {
    this.themeSongAudio.pause();
  }

  playMainSong() {
    this.isMainSongPlaying = true;
    this.mainSongAudio.play();
  }
}
